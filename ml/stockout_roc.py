...
![Stockout-risk ROC curves by reference position c](../figures/stockout_roc_curves.png)
![Stockout-risk precision-recall curves by reference position c](../figures/stockout_pr_curves.png)

(Figures generated by `ml/metrics_figures.py`; rerun it after rerunning this script if the curve data changes.)
