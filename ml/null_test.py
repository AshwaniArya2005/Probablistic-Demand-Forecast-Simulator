"""Shuffled-demand null test (tuning folds F2 and F4 only; no test-window data). If the simulator or the policy levels leaked information about realised demand, or if a reported edge were an
...
if __name__ == "__main__":
    ...
    md = f"""# Shuffled-demand null test (tuning folds F2 and F4, report-only)
...
"""
    (ROOT / "docs" / "results" / "phase11_null_test_tuning.md").write_text(md, encoding="utf-8")
    print(md)
